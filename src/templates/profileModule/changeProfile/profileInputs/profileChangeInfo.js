...
var profileChangeInfoTemplate_hbs_1 = require("./profileChangeInfoTemplate.hbs");
var profile_module_style_scss_1 = require("../../profile.module.style.scss");
var profileChangeInfoTemplateModule = function () {
    var context = {
        link: "#/Profile",
        goToProfile: "Профиль",
        profileData: [
    ...
    return (0, profileChangeInfoTemplate_hbs_1.default)(context);
};
