...
```
### Рефакторинг
После окончания обучения, я решил отрефакторить свой код, было добавлено
или исправлено:
1. Адаптивная верстка
2. Добавлен новый метод жизненного цикла - componentWillUnmount
3. Оптимизация

[Об оптимизации хотелось бы сказать отдельно](./docs/OPTIMISATION.md)